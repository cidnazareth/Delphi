   ...
   try
      ...
      with Arquivo do
         begin
            ...
            WriteString('DADOS','LINHA01', dmCliente.Encrypt(Linha01));
            WriteString('DADOS','LINHA02', dmCliente.Encrypt(Linha02));
            WriteString('DADOS','LINHA03', dmCliente.Encrypt(Linha03));
            WriteString('DADOS','LINHA04', dmCliente.Encrypt(Linha04));
...
begin
   ...
   EdLinha01.text := dmCliente.Decrypt(Arquivo.ReadString('DADOS','LINHA01',''));
   EdLinha02.text := dmCliente.Decrypt(Arquivo.ReadString('DADOS','LINHA02',''));
   EdLinha03.text := dmCliente.Decrypt(Arquivo.ReadString('DADOS','LINHA03',''));
   EdLinha04.text := dmCliente.Decrypt(Arquivo.ReadString('DADOS','LINHA04',''));
end;
